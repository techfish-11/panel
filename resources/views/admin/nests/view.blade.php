...
<div class="row">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>これは、サービス内のすべてのオプションを包含する説明的なカテゴリ名である必要があります。</small></p>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <div class="col-md-6">
        <div class="box">
            <div class="box-body">
                <div class="form-group">
                    <label class="control-label">ネスト ID</label>
                    <div>
                        <input type="text" readonly class="form-control" value="{{ $nest->id }}" />
                        <p class="text-muted small">このネストを内部および API 経由で識別するために使用される一意の ID。</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">このサービスオプションの作成者。公式オプション <code>support@pterodactyl.io</code> によって作成されたものでない限り、質問や問題は作成者にお問い合わせください。</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">このオプションを使用するすべてのサーバーに、識別目的のために割り当てられる UUID。</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-footer">
                <a href="{{ route('admin.nests.egg.new') }}"><button class="btn btn-success btn-sm pull-right">新規エッグ</button></a>
            </div>
        </div>
    </div>
</div>
