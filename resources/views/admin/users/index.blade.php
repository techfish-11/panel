                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="このユーザーがオーナーとしてマークされているサーバー。">所有サーバー</span></th>
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="このユーザーがサブユーザーとしてマークされているためアクセスできるサーバー。">アクセス可能</span></th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
