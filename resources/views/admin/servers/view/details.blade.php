...
@section('content-header')
    <h1>{{ $server->name }}<small>このサーバーのオーナーとコンテナを含む詳細を編集します。</small></h1>
    <ol class="breadcrumb">
            ...
            <form action="{{ route('admin.servers.view.details', $server->id) }}" method="POST">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <p class="text-muted small">このサーバーに外部識別子を割り当てない場合は空のままにしてください。外部 ID はこのサーバーに対して一意であり、他のどのサーバーにも使用されていない必要があります。</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-muted small">このフィールドを、このシステムの別のユーザーと一致するメールアドレスに変更することで、このサーバーのオーナーを変更できます。これを行うと、新しいデーモンセキュリティトークンが自動的に生成されます。</p>
                    </div>
                    <div class="form-group">
